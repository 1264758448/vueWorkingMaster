                                           ...
                                           <ul>
                                                    ...
                                                    <li>                   
                                                        ...
                                                        <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
                                                            ...
                                                            <div>
                                                                <el-input v-model="sizeForm.tmsTransGoodsList[0].goodsName" prefix-icon="el-icon-search" placeholder="请输入内容">
                                                                        <el-button slot="append" icon="el-icon-search" @click='foursE'></el-button>
                                                                </el-input>
                                                            </div>
                                                            </el-form-item>
                                                        </el-form>
                                                 ...
                                                 <li>                          
                                                     <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
                                                         ...
                                                         <el-input v-model="sizeForm.tmsTransGoodsList[0].goodsNum"></el-input>
                                                         </el-form-item>
                                                     </el-form>
                                                 </li>
                                                 <li>                          
                                                     <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
                                                         ...
                                                         <el-input v-model="sizeForm.tmsTransGoodsList[0].goodsVol"></el-input>
                                                         </el-form-item>
                                                     </el-form>
                                                 </li>
                                                  <li>                          
                                                     <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
                                                         ...
                                                         <el-input v-model="sizeForm.tmsTransGoodsList[0].goodsWeight"></el-input>
                                                         </el-form-item>
                                                     </el-form>
                                                 </li>
                                           </ul>
                  ...
                  <ul>
                            <li>                          
                                <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
                                    ...
                                    <el-input type="textarea" v-model="sizeForm.transMemo"></el-input>
                                </el-form-item>
                                </el-form>
  ...
  export default {
    data() {
      return {
        ...
        // 动态数组
            tmsTransGoodsList:[],
        // 将勾选的货物存起来放到,点击保存的时候赋值给this.sizeForm.tmsTransGoodsList
            hwChecks:[]
      }
    },
    created(){
    ...
    methods: {
        dEnter(){
            console.log(this.tmsTransGoodsList,'denter')
        },
        // 删除
        handleDelete(a, b){
            let c = this.tmsTransGoodsList
                console.log(a,b,'shssss')
                this.tmsTransGoodsList.splice(a,1);
                  let wei = 0
                 // 体积
                let tiji = 0
                // 数量
                ...
                // this.sizeForm.tmsTransGoodsList=this.hwChecks
            }else{
        ...
        wtss(wt){
            ...
            this.sizeForm.tmsTransGoodsList[0].goodsName=wt.goodsCnName
            this.sizeForm.tmsTransGoodsList[0].goodsId=wt.goodsId
            this.sizeForm.tmsTransGoodsList[0].goodsVol=wt.goodsVolume
            this.sizeForm.tmsTransGoodsList[0].goodsWeight=wt.goodsWeight
             this.sizeForm.tmsTransGoodsList[0].goodsNum=wt.goodsNum
            console.log(wt,'wwwwtttt')
        },
        wts(wt){
            console.log(wt,'wt')
...
// -------------------------------------------------------------------
        ...
        handleSelectionChange(val){
            ...
            // 计算总重量总体积总数量
                ...
                // 数量
                let num = 0
                if(this.hwChecks.length > 0){
                 this.hwChecks.forEach(i=>{
                    wei +=i.goodsWeight*i.goodsNum
                    tiji +=i.goodsVol*i.goodsNum
                    num += 1*i.goodsNum
                })
        ...
        newHw(){
            ...
            this.sizeForm.tmsTransGoodsList[0].goodsName=null
             this.sizeForm.tmsTransGoodsList[0].goodsNum=null
              this.sizeForm.tmsTransGoodsList[0].goodsVol=null
               this.sizeForm.tmsTransGoodsList[0].goodsWeight=null
        },
        // 第一弹框确定
        elevies(){
             this.dialogVisible11=!this.dialogVisible11
             let a = this.tmsTransGoodsList
            let n = {
                   "comId": this.wtkhId,
                   "goodsId":   this.sizeForm.tmsTransGoodsList[0].goodsId,
                   "goodsName": this.sizeForm.tmsTransGoodsList[0].goodsName,
                   "goodsNum":  this.sizeForm.tmsTransGoodsList[0].goodsNum,
                   "goodsVol": this.sizeForm.tmsTransGoodsList[0].goodsVol,
                   "goodsWeight": this.sizeForm.tmsTransGoodsList[0].goodsWeight,
                }
...
// --------------------------------------------------------
      ...
      handlePreview(file) {
        ...
        xms(xm){
            // console.log( this.sizeForm.tmsTransGoodsList[0],'[][][][][][][]')
            this.xiangmus=xm
        ...
        add(){
             this.$http.post("v1/trans/insert/",this.sizeForm).then(res => {
